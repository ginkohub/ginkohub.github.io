<script>
	...
	const tabs = Object.entries(tabModules).map(([path, moduleFunc]) => {
	...
	const backgrounds = [
		...
		'https://images.unsplash.com/photo-1444464666168-49d633b867ad?auto=format&fit=crop&w=1200&q=60&fm=webp',
