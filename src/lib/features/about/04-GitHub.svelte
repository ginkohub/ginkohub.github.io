...
<div class="pt-10 space-y-6">
	<h2 class="text-[9px] font-bold uppercase tracking-widest text-slate-400">System Artifacts (GitHub)</h2>
	
	<div class="grid grid-cols-3 gap-4">
		<div class="flex flex-col p-4 bg-slate-900/30 border border-slate-800/50 group hover:border-white/20 transition-all">
			<span class="text-[8px] font-black uppercase tracking-widest text-slate-500 mb-1">Repositories</span>
			<span class="text-xl font-bold font-space text-white tabular-nums group-hover:scale-110 origin-left transition-transform" style="color: {accentColor}">
				{stats.repos}
			</span>
		</div>
		
		<div class="flex flex-col p-4 bg-slate-900/30 border border-slate-800/50 group hover:border-white/20 transition-all">
			<span class="text-[8px] font-black uppercase tracking-widest text-slate-500 mb-1">Followers</span>
			<span class="text-xl font-bold font-space text-white tabular-nums group-hover:scale-110 origin-left transition-transform" style="color: {accentColor}">
				{stats.followers}
			</span>
		</div>
		...
		<div class="flex flex-col p-4 bg-slate-900/30 border border-slate-800/50 group hover:border-white/20 transition-all">
			<span class="text-[8px] font-black uppercase tracking-widest text-slate-500 mb-1">Total Stars</span>
			<span class="text-xl font-bold font-space text-white tabular-nums group-hover:scale-110 origin-left transition-transform" style="color: {accentColor}">
				{stats.stars}
			</span>
		</div>
